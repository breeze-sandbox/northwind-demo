...
var app = express();
var docRoot = path.join(__dirname, '../northwind/');
...
// all other breeze queries go to routes
app.get('/breeze/query/:slug', account.isLoggedIn(), noCache, routes.get);
app.get('/breeze/:slug', account.isLoggedIn(), noCache, routes.get);
